...
import ru.t1.apupynin.accountms.repository.ErrorLogRepository;
...
public class LogDatasourceErrorAspect {
    ...
    @AfterThrowing(pointcut = "@annotation(ru.t1.apupynin.accountms.annotation.LogDatasourceError)", throwing = "exception")
