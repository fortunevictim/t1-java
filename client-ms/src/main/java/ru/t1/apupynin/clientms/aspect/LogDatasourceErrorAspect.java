...
import ru.t1.apupynin.clientms.repository.ErrorLogRepository;
...
public class LogDatasourceErrorAspect {
    ...
    @AfterThrowing(pointcut = "@annotation(ru.t1.apupynin.clientms.annotation.LogDatasourceError)", throwing = "exception")
